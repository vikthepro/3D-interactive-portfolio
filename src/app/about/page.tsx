...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "devilsvik2@gmail.com",
    href: "mailto:devilsvik2@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/chepuri-vikas-b7b54224a/",
    content: "/chepuri-vikas-b7b54224a",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/vikthepro",
    content: "/vikthepro",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Chepuri Vikas</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Chepuri Vikas, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
